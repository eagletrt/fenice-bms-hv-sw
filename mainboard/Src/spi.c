...
void HAL_SPI_MspInit(SPI_HandleTypeDef* spiHandle)
{
  ...
  /* USER CODE END SPI3_MspInit 0 */
    ...
    PB3     ------> SPI3_SCK
    */
    GPIO_InitStruct.Pin = MONITOR_MISO_Pin|MONITOR_MOSI_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
    ...
    GPIO_InitStruct.Pin = MONITOR_SCK_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF6_SPI3;
    HAL_GPIO_Init(MONITOR_SCK_GPIO_Port, &GPIO_InitStruct);
...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* spiHandle)
{
  ...
  /* USER CODE END SPI3_MspDeInit 0 */
    ...
    PB3     ------> SPI3_SCK
    */
    HAL_GPIO_DeInit(GPIOC, MONITOR_MISO_Pin|MONITOR_MOSI_Pin);

    HAL_GPIO_DeInit(MONITOR_SCK_GPIO_Port, MONITOR_SCK_Pin);
