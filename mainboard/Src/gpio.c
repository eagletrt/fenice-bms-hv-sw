...
void MX_GPIO_Init(void) {
    ...
    HAL_GPIO_WritePin(
        GPIOC, MUX_A3_Pin | MUX_A2_Pin | MUX_A1_Pin | MUX_A0_Pin | BMS_FAULT_Pin | PRECHARGE_Pin, GPIO_PIN_RESET);
    ...
    /*Configure GPIO pins : PCPin PCPin PCPin PCPin
                           ...
                           PCPin PCPin PCPin */
    GPIO_InitStruct.Pin = MUX_A3_Pin | MUX_A2_Pin | MUX_A1_Pin | MUX_A0_Pin | CS_ADC_Pin | EEPROM_CS_Pin |
                          EEPROM_HOLD_Pin | CARD_CS_Pin | BMS_FAULT_Pin | PRECHARGE_Pin | AIRN_OFF_Pin;
