...
void cell_voltage_check_errors() {
    ...
    ERROR_TOGGLE_CHECK_STR(max > CELL_MAX_VOLTAGE, ERROR_CELL_OVER_VOLTAGE, error_pack_instance);
    ERROR_TOGGLE_CHECK_STR(min < CELL_MIN_VOLTAGE, ERROR_CELL_UNDER_VOLTAGE, error_pack_instance);
    ERROR_TOGGLE_CHECK_STR(min < CELL_WARN_VOLTAGE, ERROR_CELL_LOW_VOLTAGE, error_pack_instance);
}