...
#define SIGNALS_INOUT_INTERLOCK_OUT_Pin       GPIO_PIN_10
#define SIGNALS_INOUT_INTERLOCK_OUT_GPIO_Port GPIOB
#define SIGNALS_INOUT_INTERLOCK_IN_Pin        GPIO_PIN_12
#define SIGNALS_INOUT_INTERLOCK_IN_GPIO_Port  GPIOB
