...
#define FEEDBACK_TS_OFF_VAL \
        FEEDBACK_CHECK_MUX | FEEDBACK_AIRP | FEEDBACK_AIRN | FEEDBACK_LATCH_BMS | FEEDBACK_BMS_FAULT | FEEDBACK_TSAL_OVER60V | FEEDBACK_TSAL_GREEN
...
#define FEEDBACK_AIRN_CLOSE_VAL \
        FEEDBACK_CHECK_MUX | FEEDBACK_AIRP | FEEDBACK_AIRN | FEEDBACK_FROM_SD | FEEDBACK_LATCH_IMD \
        | FEEDBACK_LATCH_BMS | FEEDBACK_IMD_FAULT | FEEDBACK_BMS_FAULT | FEEDBACK_TO_TSMS | FEEDBACK_FROM_TSMS | FEEDBACK_TS_ON
...
#define FEEDBACK_PC_ON_VAL \
        FEEDBACK_CHECK_MUX | FEEDBACK_AIRP | FEEDBACK_AIRN_GATE | FEEDBACK_FROM_SD | FEEDBACK_LATCH_IMD \
        | FEEDBACK_LATCH_BMS | FEEDBACK_IMD_FAULT | FEEDBACK_BMS_FAULT | FEEDBACK_TO_TSMS | FEEDBACK_FROM_TSMS \
        | FEEDBACK_TS_ON | FEEDBACK_RELAY_SD | FEEDBACK_IMD_SD | FEEDBACK_BMS_SD | FEEDBACK_TS_ON
