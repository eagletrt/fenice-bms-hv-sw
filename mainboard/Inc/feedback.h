...
#define FEEDBACK_ON_LOW                                                                                         \
    (FEEDBACK_AIRN_STATUS | FEEDBACK_AIRP_STATUS | FEEDBACK_TS_OVER_60V_STATUS | FEEDBACK_TSP_OVER_60V_STATUS | \
     FEEDBACK_TSAL_GREEN)

#define FEEDBACK_ON_VAL  (FEEDBACK_ON_HIGH)
#define FEEDBACK_ON_MASK ((FEEDBACK_ON_HIGH) | (FEEDBACK_ON_LOW))

#define FEEDBACK_FAULT_EXIT_HIGH                                                                    \
    (FEEDBACK_CHECK_MUX | FEEDBACK_AIRN_STATUS | FEEDBACK_AIRP_STATUS | FEEDBACK_TSAL_GREEN_FAULT | \
...
#define FEEDBACK_CONNECTOR_HIGH (FEEDBACK_TSAL_GREEN_FAULT_LATCHED)
#define FEEDBACK_CONNECTOR_LOW  (FEEDBACK_NULL)

#define FEEDBACK_CONNECTOR_VAL  (FEEDBACK_CONNECTOR_HIGH)
#define FEEDBACK_CONNECTOR_MASK ((FEEDBACK_CONNECTOR_HIGH) | (FEEDBACK_CONNECTOR_LOW))
