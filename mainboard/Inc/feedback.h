...
#define FB_TIMEOUT_MS        50

typedef uint32_t feedback_t;

extern uint64_t feedback;

#define FEEDBACK_TS_OFF_HIGH FEEDBACK_CHECK_MUX

#define FEEDBACK_TS_OFF_LOW FEEDBACK_NULL

#define FEEDBACK_TS_OFF_VAL  FEEDBACK_TS_OFF_HIGH
#define FEEDBACK_TS_OFF_MASK (FEEDBACK_TS_OFF_HIGH | FEEDBACK_TS_OFF_LOW)

#define FEEDBACK_TS_ON_HIGH FEEDBACK_CHECK_MUX

#define FEEDBACK_TS_ON_LOW FEEDBACK_NULL

#define FEEDBACK_TS_ON_VAL  FEEDBACK_TS_ON_HIGH
#define FEEDBACK_TS_ON_MASK (FEEDBACK_TS_ON_HIGH | FEEDBACK_TS_ON_LOW)

#define FEEDBACK_AIRN_CLOSE_HIGH FEEDBACK_CHECK_MUX

#define FEEDBACK_AIRN_CLOSE_LOW FEEDBACK_NULL
...
#define FEEDBACK_AIRN_STATUS_HIGH FEEDBACK_CHECK_MUX

#define FEEDBACK_AIRN_STATUS_LOW FEEDBACK_NULL
...
#define FEEDBACK_PC_ON_HIGH FEEDBACK_CHECK_MUX

#define FEEDBACK_PC_ON_LOW FEEDBACK_NULL

#define FEEDBACK_PC_ON_VAL  FEEDBACK_PC_ON_HIGH
#define FEEDBACK_PC_ON_MASK (FEEDBACK_PC_ON_HIGH | FEEDBACK_PC_ON_LOW)

#define FEEDBACK_ON_HIGH FEEDBACK_CHECK_MUX

#define FEEDBACK_ON_LOW FEEDBACK_NULL

#define FEEDBACK_ON_VAL  FEEDBACK_ON_HIGH
#define FEEDBACK_ON_MASK (FEEDBACK_ON_HIGH | FEEDBACK_ON_LOW)

#define FEEDBACK_FAULT_EXIT_HIGH FEEDBACK_CHECK_MUX

#define FEEDBACK_FAULT_EXIT_LOW FEEDBACK_NULL
...
#define FEEDBACK_CONVERT_ADC_TO_VOLTAGE(VALUE) ((VALUE) * (3.3F / 4095 * 4.3f))
